...
Once you have finished your project, you should push your changes and publish your branch. Then, create a pull request to the main repository. A reviewer will check your project and merge it into the main branch, or suggest changes.